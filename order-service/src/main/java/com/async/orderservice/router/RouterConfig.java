package com.async.orderservice.router;

import com.async.orderservice.handler.OrderHandler;
...
//                .andRoute(RequestPredicates.GET(ENDPOINT_PATH + "orders"),  handler::getOrders);
